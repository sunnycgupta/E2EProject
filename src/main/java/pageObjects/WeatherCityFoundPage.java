...
public class WeatherCityFoundPage extends BaseTest {
	...
	@FindBy(xpath = "//a[normalize-space(.)='London, GB']")
	public WebElement linkTextLondonGB;
	
	@FindBy(xpath="//p[contains(normalize-space(),'temperature from')]")
	public WebElement textWeatherDetails;
	public WeatherCityFoundPage(WebDriver driver) {
